  ...
  Q.UI.roundRect = function(ctx, rect)
 {
  ...
  Q.UI.Container = Q.Sprite.extend("UI.Container", {
    init: function(p,defaults) {
      ...
      this._super(Q._defaults(adjustedP,defaults),{
        ...
        fill:   "#ffff00", // Set to color to add background
        highlight:   "#00ff00", // Set to color to for button
        radius: 25, // Border radius
        stroke: "#000000",
        border: false, // Set to a width to show a border
        shadow: false, // Set to true or a shadow offset
    ...
    */
    addShadow: function(ctx) {
      if(this.p.shadow) {
        ...
        ctx.shadowColor = this.p.shadowColor || "rgba(100,0,0,0.1)";
      }
    },
  ...
  /**
   ...
   Options for `p` are very similar to the ones for Q.Sprite.
     ...
     * size         - size of the text in px [18]
  ...
  Q.UI.Text = Q.Sprite.extend("UI.Text", {
    ...
    */
    ...
    font: function() {
      ...
      this.fontString = (this.p.weight || "200") + " " +
                        (this.p.size || 18) + "px " +
                        (this.p.family || "Comic Sans MS");
  ...
  /**
   ...
   Options for `p` are very similar to the ones for Q.UI.Container and Q.UI.Text.
     ...
     * font          - font for text [weigth: 400, size: 12px, family: arial]
  ...
  Q.UI.Button = Q.UI.Container.extend("UI.Button", {
    ...
    */
    setFont: function(ctx) {
      ...
      ctx.font = this.p.font || "200 24px Comic Sans MS";
